...
# This script builds the Docker image for the Allybot Connector.
...
IMAGE_NAME="us-central1-docker.pkg.dev/inorbit-integrations/connectors/allybot_connector"
IMAGE_NAME_SHORT="allybot_connector"
