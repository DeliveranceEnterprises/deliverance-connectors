...
# This script builds the Docker image for the Keenon Connector.
...
IMAGE_NAME="us-central1-docker.pkg.dev/inorbit-integrations/connectors/keenon_connector"
IMAGE_NAME_SHORT="keenon_connector"
