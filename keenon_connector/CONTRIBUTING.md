...
Ready to contribute? Here's how to set up `keenon-connector` for local development.

1. Fork the `keenon-connector` repo on [GitHub](https://github.com/deliverance-enterprises/keenon-connector).

2. Clone your fork locally:

   ```bash
   git clone git@github.com:{your_username_here}/keenon-connector.git
   ```
...
7. Submit a pull request through the [GitHub](https://github.com/deliverance-enterprises/keenon-connector/pulls) website.
...
> [!IMPORTANT]
> The message of the last commit must match the configured pattern, e.g. "Bump keenon-connector version: 0.1.0 → 0.1.1", for the publish job to run.
