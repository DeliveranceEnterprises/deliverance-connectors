...
# This script builds the Docker image for the AutoXing Cloud Connector.
...
IMAGE_NAME="us-central1-docker.pkg.dev/inorbit-integrations/connectors/autoxing_cloud_connector"
IMAGE_NAME_SHORT="autoxing_cloud_connector"
